...
for i in [0,10,1000]:
    ...
    #ax0.set_yscale("log")
    ax10.plot(wlen, flux)
    ax10.plot(wlen, maxcontfit)
    ax10.plot(maxintervalwlen, maxwinpeak,'*')
    ax10.plot(wlenline, fluxline,'.')
    #name0 = ax0.text(8750,140,sdssspecname)
    #z0 = ax0.text(9500,120,r'z = '+str(z))
    ax11 = plt.subplot(gs[4], sharex = ax10)
    ax11.plot(wlen, flux)
    ax11.plot(wlen, medcontfit)
    ax11.plot(medintervalwlen, medwinpeak,'*')
    ax11.plot(wlenline, fluxline,'.')

    ax12 = plt.subplot(gs[5], sharex = ax10)
    ax12.plot(wlen, flux)
    ax12.plot(wlen, max_medcontfit)
    ax12.plot(max_medintervalwlen, max_medwinpeak,'*')
    ax12.plot(wlenline, fluxline,'.')

...
for carlaselect in range(0,1):
    ...
    for spec in specmatch:
        spec = [spec]
        wlen, normspec, lyalpha = fitmeth.contfitv7(spec, zlim = 2.3, stonlim = 10, showplot = False, showerror = False)
    ...
    for spec in specmatch:
        spec = [spec]
        wlen, normspec, lyalpha = fitmeth.contfitv7(spec, zlim = 2.3 ,stonlim = 5, showplot = False, showerror = False)
        wlenshift = wlen/(1+gcredshift)

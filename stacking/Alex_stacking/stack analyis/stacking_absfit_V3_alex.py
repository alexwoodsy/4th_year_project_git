...
while rbins[1] <= 4000:
    ...
    #plotting output
    cutspeclen = int(carlahighreslen/3)
    ...
    ax[0].plot(wlenmultistack[:-cutspeclen], -np.log(meancarla[:-cutspeclen]))
    ...
    ax[1].plot(wlenmultistack[:-cutspeclen], medcarla[:-cutspeclen])

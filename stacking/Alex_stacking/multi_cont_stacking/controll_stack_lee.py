...
amdata = fits.getdata('Anti-Match/lee_anti-match.fits',ext=1)#import fits image
amlen = len(amdata)#
am_names = amdata.field(0)
am_plate = amdata.field(4)
am_mjd = amdata.field(5)
am_fiberid = amdata.field(6)
am_z = amdata.field(7)
am_stonall = amdata.field(9)
am_stonforest = amdata.field(10)
